...
?>
			<dd class="published">
				<span class="icon-calendar" aria-hidden="true" title="<?php echo JText::sprintf('COM_CONTENT_PUBLISHED_DATE_ON', JHtml::_('date', $displayData['item']->publish_up, JText::_('DATE_FORMAT_LC3'))); ?>">
