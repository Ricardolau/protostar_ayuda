...
{
	$html_sitename = '<span class="site-title" title="' . $sitename . '">' . htmlspecialchars($this->params->get('sitetitle'), ENT_COMPAT, 'UTF-8') . '</span>';
} else {
	$html_sitename = '<span class="site-title" title="' . $sitename . '">' . $sitename . '</span>';
}
